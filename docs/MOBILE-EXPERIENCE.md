...
- The fixed tabs are Today, Work, Collect, Serenity and More. Work opens dispatch; More keeps customers, unfinished setup, the rest of the business screens, appearance and sign-out accessible. The setup checklist stays out of the work surface until explicitly opened. Create opens a short menu of existing record forms.
