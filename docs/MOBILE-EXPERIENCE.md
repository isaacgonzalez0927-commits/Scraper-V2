...
- Menus enter with a short slide and fade; buttons and tabs give gentle press feedback, and setup content fades into place. Motion respects the device's Reduce Motion preference and adds no delay to actions.
